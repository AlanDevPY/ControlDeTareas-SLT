      ...
      html += `
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <h4 class="card-title solicitud">${asistencia.solicitud} | Generado por ${asistencia.remitente}</h4>
                    ...
                    <div class="d-flex align-items-xl-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" style="font-size: 30px;margin-right: 20px;">
                        ...
                        <div>
                            <p class="fw-bold mb-0">Mensaje Enviado a</p>
                            <p class="text-muted mb-0 nombre">${asistencia.nombre}</p>
